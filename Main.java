...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------");
        System.out.print("Создать базу игрушек ?: ");
       ...
       while (remainder > 0){
           ...
           System.out.print("Задайте вероятность выбора (от 1 до 100): ");
           ...
           tempIdToy++;
            ...
            System.out.println();
            System.out.println("---------------------------------------------");
            System.out.println("Создана база игрушек:");
       for (int i = 1; i < tempIdToy ;i++){
           System.out.println(toys[i].idToy + " - " + toys[i].weightToy + " - " + toys[i].nameToy);
            ...
            try {
                ...
                int num;
                System.out.println("------------------------------------------------");
                System.out.print("Этапов розыгрыша будет: ");
                ...
                pw.close();
                System.out.println("------------------------------------------------");
                System.out.println("Итоги проведения розыгрыша в файле result.txt");
            } catch (IOException e) {
